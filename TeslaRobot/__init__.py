...
#-----------------------------------------------TeslaRobot/services/telethonuserbot.py (ENV)-------------------------------------------------------    
...
telethn = TelegramClient("tesla", API_ID, API_HASH)
pbot = Client("teslarobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from TeslaRobot.modules.helper_funcs.handlers import (
